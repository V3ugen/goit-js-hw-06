...
const emailEl = logFormEl.firstElementChild.firstElementChild.value;
const passwordEl = logFormEl.firstElementChild.nextElementSibling.firstElementChild.value;
const button = logFormEl.lastElementChild ;
const user = [] ;
